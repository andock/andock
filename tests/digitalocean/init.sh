...
doctl_id=$(doctl compute droplet create "andock-travis-${slug}" --size 2gb --image ${slug} --region fra1 --ssh-keys b6:3c:4d:07:15:8c:7c:43:43:71:e3:61:a3:2d:f1:db,4b:df:d0:74:35:11:97:a7:93:87:a7:4a:b1:66:9b:a3 --wait --no-header --format ID)
...
echo "Sleep for 5 minutes to be sure everything is up."
sleep 360